<template>
  ...
  <div class="rulesContainer">
    <ol class="rulesList">
      ...
      <li>After the best tee shot is selected, both players take their second shot from that spot. This process continues
      ...
      <li>Any disputes regarding rules should be resolved by a designated rules official or through a majority decision of
